...
imageftbbox(): Argument #1 ($size) must be between %d and %d
imagettfbbox(): Argument #1 ($size) must be between %d and %d
imageftbbox(): Argument #1 ($size) must be between %d and %d
imagettfbbox(): Argument #1 ($size) must be between %d and %d
imageftbbox(): Argument #1 ($size) must be between %d and %d
imagettfbbox(): Argument #1 ($size) must be between %d and %d
...
imagefttext(): Argument #2 ($size) must be between %d and %d
imagettftext(): Argument #2 ($size) must be between %d and %d
